    ...
    <>
      <div className="grow w-full max-w-xl mx-auto px-4 sm:px-6 py-12 lg:pt-24 lg:pb-20">
        ...
        <article className="divide-y divide-slate-100 dark:divide-slate-800 -mt-8 mb-4">
          <Brief>
            The client is looking to review and revamp the information architecture, user experience and user interface design of <strong className="text-slate-900 dark:text-slate-200 font-medium">The Markyk Corp.</strong>, a web application that connects landlords and tenants across Europe and America.
          </Brief>
